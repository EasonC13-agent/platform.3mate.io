      ...
      <div className="bg-gray-800 p-8 rounded-xl w-full max-w-md">
        ...
        <form onSubmit={handleEmailAuth} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 rounded-lg font-medium"
          >
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-2 bg-white text-gray-900 hover:bg-gray-100 disabled:bg-gray-300 rounded-lg font-medium flex items-center justify-center gap-2"
        >
